...
@Component({
  selector: 'app-cost-avoidance',
  templateUrl: './cost-avoidance.component.html',
  styleUrls: ['./cost-avoidance.component.css']
})
export class CostAvoidanceComponent implements OnInit {
  costAvoidance: any={};
  ...
  ngOnInit(): void {
    this.costAvoidance = MockData.cost_avoidance;
    this.dtOptions = {
  ...
  filterData(): void {
    const tempSourceData = JSON.parse(JSON.stringify(MockData.cost_avoidance));
    const newData = {
      columns: [] as any,
      data: []
    };
